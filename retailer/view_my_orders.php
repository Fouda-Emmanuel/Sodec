        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            if (isset($_POST['confirmed_order_id'])) {
                ...
                if (mysqli_query($con, $query_confirmOrder)) {
                   ...
                   // After confirming the order and updating the database, insert a notification for the manufacturer
...
// Set notification message for the head of service (manufacturer) in session variable
$_SESSION['head_of_service_notification'] = "Order (ID: $confirmed_order_id) has been confirmed and received by the retailer.";
